...
header <- c("Player Num", "Player Name", "Total Points", "Player State",	"USCF ID",	"Pre-Rating",	"Post-Rating")
...
header <- c("Player Num",   "Round", "Outcome",
...
header <- c("Player Num",   "Player Name", "Player </br> State",
